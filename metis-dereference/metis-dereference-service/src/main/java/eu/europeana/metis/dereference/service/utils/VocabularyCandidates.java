...
public final class VocabularyCandidates {
  ...
  /**
   * Return the vocabularies that match the given resource identifier. A vocabulary matches the
   * given resource Id if and only if the resource ID starts with one of the vocabulary URIs.
   *
   ...
   * the URL contains a given string. This function will be called once for the host name of the
   * resource to allow persistence to greatly narrow down the list of candidate vocabularies before
   * they are loaded in memory and processed.
