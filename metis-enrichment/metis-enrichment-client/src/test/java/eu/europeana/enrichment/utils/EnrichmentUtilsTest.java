...
public class EnrichmentUtilsTest {
	 ...
	 @Test
	 public void testExtractedFieldValuesForEnrichment() throws IOException {
		 RDF rdf = new RDF();
		 ...
		 for (InputValue inputValue : result) {
			 resultProcessed.add(inputValue.getValue() + "|" + inputValue.getLanguage() + "|" + inputValue.getOriginalField());
		 }
