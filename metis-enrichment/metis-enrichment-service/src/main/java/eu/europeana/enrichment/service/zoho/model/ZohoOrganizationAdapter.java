...
public class ZohoOrganizationAdapter implements ZohoOrganization {
  ...
  /**
   * Constructor with {@link JsonNode} Zoho organization response that gets parsed to a list of
   * {@link ZohoResponseField}s
   *
   * @param response the json Zoho response
   * @throws ZohoAccessException in case the Zoho repsonse cannot be parsed
   */
  ...
  /**
   * This method retrieves 'content' value from array of Zoho 'value'/'content' pairs, if such a
   * value exists.
   *
  ...
  /**
   * This methods retrieves multiple values of one base field (e.g. alternatives). It checks maximal
   * number of such fields limited by passed size parameter.
   *
