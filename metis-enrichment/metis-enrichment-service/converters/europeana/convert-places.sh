...
mvn clean install
mvn exec:exec -Dexec.workingdir="$ANNOCULTOR_HOME" -Dexec.args="-cp %classpath $MAVEN_OPTS eu.annocultor.xconverter.impl.Converter profile/profile-places.xml tmp/work"
