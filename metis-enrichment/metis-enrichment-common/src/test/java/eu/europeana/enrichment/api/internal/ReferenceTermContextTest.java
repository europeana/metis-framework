...
class ReferenceTermContextTest {
  ...
  void createFromString() {
    ReferenceTermContext referenceTermContext = ReferenceTermContext.createFromString("http://reference",
  ...
  void referenceEquals() {
    ReferenceTermContext referenceTermContext = ReferenceTermContext.createFromString("http://reference",
        Set.of(ProxyFieldType.DCTERMS_SPATIAL));
    ReferenceTermContext referenceTermContext2 = ReferenceTermContext.createFromString("http://reference",
        Set.of(ProxyFieldType.DCTERMS_SPATIAL));
