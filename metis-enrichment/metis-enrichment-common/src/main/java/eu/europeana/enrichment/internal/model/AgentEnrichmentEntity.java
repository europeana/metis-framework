...
public class AgentEnrichmentEntity extends AbstractEnrichmentEntity {
  ...
  public void setEdmWasPresentAt(String[] edmWasPresentAt) {
    this.edmWasPresentAt = edmWasPresentAt == null ? null : edmWasPresentAt.clone();
  }

  public String[] getEdmWasPresentAt() {
    return (StringArrayUtils.isNotBlank(this.edmWasPresentAt) ? this.edmWasPresentAt.clone()
        : null);
  }
  ...
  public int hashCode() {
    int hash = 7;
    return 31 * hash + (null == this.getAbout() ? 0 : this.getAbout().hashCode());
  }
}
