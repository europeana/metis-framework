...
import eu.europeana.indexing.record.v2.property.MongoObjectUpdater;
...
public abstract class AbstractMongoObjectUpdater<R, A> implements MongoObjectUpdater<R, A> {
  ...
  @Override
  public final R update(R newEntity, A ancestorInformation, Date recordDate, Date recordCreationDate, RecordDao mongoServer) {
