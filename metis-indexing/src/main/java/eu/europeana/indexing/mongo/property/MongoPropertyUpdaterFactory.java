...
public final class MongoPropertyUpdaterFactory {
  ...
  private static <T> MongoPropertyUpdater<T> create(T updated, EdmMongoServer mongoServer,
  ...
  public static <T> MongoPropertyUpdater<T> createForObjectWithoutAbout(T updated,
      EdmMongoServer mongoServer, Supplier<Query<T>> queryCreator,
  ...
  public static <T> MongoPropertyUpdater<T> createForObjectWithAbout(T updated,
      EdmMongoServer mongoServer, Class<T> objectClass, Function<T, String> aboutGetter,
