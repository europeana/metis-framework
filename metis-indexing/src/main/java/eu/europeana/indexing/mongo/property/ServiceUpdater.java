...
public class ServiceUpdater implements PropertyMongoUpdater<ServiceImpl> {
  ...
  @Override
  public ServiceImpl update(ServiceImpl mongoEntity, ServiceImpl newEntity, MongoServer mongoServer)
    ...
    if (!MongoUtils.arrayEquals(mongoEntity.getDctermsConformsTo(),
