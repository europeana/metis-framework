...
public class CommonTagExtractor {
  ...
  /**
   * Codifies the mediatype of the given resource
   * 
   * @param metaInfo the metainfo of the resource
  ...
  public static Integer getMediaTypeCode(SourceDocumentReferenceMetaInfo metaInfo) {
    if (metaInfo == null)
      return 0;
    else if (metaInfo.getImageMetaInfo() != null)
      return 1;
    else if (metaInfo.getAudioMetaInfo() != null)
      return 2;
    else if (metaInfo.getVideoMetaInfo() != null)
      return 3;
    else if (metaInfo.getTextMetaInfo() != null)
      return 4;
    else
      return 0;
  }
