package eu.europeana.indexing.search.v2.facet;

import eu.europeana.indexing.search.v2.facet.value.AudioDuration;
import eu.europeana.indexing.search.v2.facet.value.AudioQuality;
import eu.europeana.indexing.search.v2.facet.value.FacetValue;
import eu.europeana.indexing.search.v2.facet.value.ImageAspectRatio;
import eu.europeana.indexing.search.v2.facet.value.ImageColorEncoding;
import eu.europeana.indexing.search.v2.facet.value.ImageColorSpace;
import eu.europeana.indexing.search.v2.facet.value.ImageSize;
import eu.europeana.indexing.search.v2.facet.value.MediaTypeEncoding;
import eu.europeana.indexing.search.v2.facet.value.MimeTypeEncoding;
import eu.europeana.indexing.search.v2.facet.value.VideoDuration;
import eu.europeana.indexing.search.v2.facet.value.VideoQuality;
