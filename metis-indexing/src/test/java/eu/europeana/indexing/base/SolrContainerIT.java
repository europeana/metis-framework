...
public class SolrContainerIT extends TestContainer {
     ...
     */
    public static final String SOLR_VERSION = "solr:9.10.1-slim";
    /**
     * The constant SOLR_COLLECTION_NAME.
     */
    public static final String SOLR_COLLECTION_NAME = "solr_publish_test";

    private static final String GITHUB_RAW_BASE_URL = "https://raw.githubusercontent.com/europeana/search/refs/heads/upgrade_solr9.10/solr_confs/metadata/conf/";
    ...
    private static final String ALIASING_LIB_JAR = "searchcomponent-alias-1.0-SNAPSHOT.jar";
    private static final String ALIASING_LIB_CONTAINER_PATH = "/opt/solr/lib/" + ALIASING_LIB_JAR;
    private static final String ALIASING_LIB_RESOURCE_PATH = "solr/" + ALIASING_LIB_JAR;
    private static final String QUERY_ALIASES_PATH = "/var/solr/data/solr_publish_test_shard1_replica_n1/conf/" + QUERY_ALIASES_FILE;
    private static final String FILE_PERMISSIONS = "644";
    private static final String OWNERSHIP_COMMAND = "mkdir -p /opt/solr/data && chown -R solr:solr /opt/solr/";
