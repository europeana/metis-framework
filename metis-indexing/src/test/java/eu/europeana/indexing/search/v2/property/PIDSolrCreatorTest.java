...
class PIDSolrCreatorTest {
  ...
  void addAllToDocumentWithPidSolrCreator() {
    PersistentIdentifierImpl pid1 = new PersistentIdentifierImpl();
    pid1.setAbout("about");
    ...
    pid2.setHasURL(List.of("has url"));
    ...
    assertIterableEquals(List.of("ark:/12148/bpt6k279982", "ark:/12145/bpt6k279981"),
        solrInputDocument.getFieldValues(SolrV2Field.PID.toString()));
  }
}
