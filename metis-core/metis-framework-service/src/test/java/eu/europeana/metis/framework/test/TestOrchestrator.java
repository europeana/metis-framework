...
public class TestOrchestrator {
    ...
    public void testCreationOfExecution() throws NoDatasetFoundException {
        ...
        try {
            ...
            Assert.assertNotNull(orchestrator.getExecutionsByDates(execution.getStartedAt(),new Date(),null));
            Assert.assertEquals(1,orchestrator.getExecutionsByDates(execution.getStartedAt(),new Date(),null));
            ...
            Assert.assertEquals(0,orchestrator.getAllExecutionsForDatasetByDates("test1",0,1,execution.getStartedAt(),execution.getFinishedAt(),null).size());
            Assert.assertEquals(1,orchestrator.getAllExecutionsForDatasetByDates("test",0,1,execution.getStartedAt(),execution.getFinishedAt(),null).size());
