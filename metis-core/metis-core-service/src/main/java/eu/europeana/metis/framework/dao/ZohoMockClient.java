...
import eu.europeana.metis.framework.common.Domain;
import eu.europeana.metis.framework.common.GeographicLevel;
import eu.europeana.metis.framework.common.Role;
import eu.europeana.metis.framework.common.Sector;
import eu.europeana.metis.framework.crm.ContactResponse;
import eu.europeana.metis.framework.crm.ContactResult;
import eu.europeana.metis.framework.crm.Field;
import eu.europeana.metis.framework.crm.Module;
import eu.europeana.metis.framework.crm.OrganizationResponse;
import eu.europeana.metis.framework.crm.OrganizationResult;
import eu.europeana.metis.framework.crm.Row;
import eu.europeana.metis.framework.crm.ZohoContactResponse;
import eu.europeana.metis.framework.crm.ZohoFields;
import eu.europeana.metis.framework.crm.ZohoOrganizationResponse;
