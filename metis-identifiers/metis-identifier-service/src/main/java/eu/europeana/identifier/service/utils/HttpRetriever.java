...
public class HttpRetriever implements Iterator<String> {
	...
	public  HttpRetriever createInstance(URL url)
		...
		TarArchiveInputStream tarfile;
			...
			tarfile =  new TarArchiveInputStream(new GzipCompressorInputStream(new FileInputStream(destFile)));
			...
			TarArchiveInputStream iterabletarfile = new TarArchiveInputStream(new GzipCompressorInputStream(new FileInputStream(destFile)));
