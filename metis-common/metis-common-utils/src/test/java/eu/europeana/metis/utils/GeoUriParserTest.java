...
class GeoUriParserTest {
  ...
  void parse() throws Exception {
    ...
    Assertions.assertThrows(BadContentException.class, () -> GeoUriParser.parse("geo: 37.786971,-122.399677"));
    Assertions.assertThrows(BadContentException.class, () -> GeoUriParser.parse("geo:37.786971,-122.399677; u=35"));

    //Non geo
    Assertions.assertThrows(BadContentException.class, () -> GeoUriParser.parse("test:"));
