...
public final class RestEndpoints {
  ...
  public static final String ORCHESTRATOR_WORKFLOWS_EXECUTIONS_DATASET_DATASETID_LATEST_PLUGIN = "/orchestrator/workflows/executions/dataset/{datasetId}/latest_plugin";
