package eu.europeana.normalization.common.util.nlp;
...
public class CyrillicGreekCombinedTransliterator {
  ...
  public CyrillicGreekCombinedTransliterator() {
    translit = Transliterator.getInstance(
  ...
  public static void main(String[] args) throws Exception {
    ...
    Transliterator translit = Transliterator.getInstance(
        "Greek-Latin/UNGEGN; nfd; [:Nonspacing Mark:] remove; [:Punctuation:] remove; nfc; Lower");
