...
import eu.europeana.metis.templates.pandora.dashboard.Banner;
import eu.europeana.metis.templates.pandora.dashboard.Content;
import eu.europeana.metis.templates.pandora.dashboard.ForgotLoginCredentials;
import eu.europeana.metis.templates.pandora.dashboard.HeroConfig;
import eu.europeana.metis.templates.pandora.dashboard.LandingPageContent;
import eu.europeana.metis.templates.pandora.dashboard.LoginForm;
import eu.europeana.metis.templates.pandora.dashboard.MetisLandingPageModel;
import eu.europeana.metis.templates.pandora.dashboard.PageConfig;
