...
import eu.europeana.validation.exceptions.BatchValidationException;
import eu.europeana.validation.exceptions.ServerException;
...
public class ValidationController {
    ...
    public ValidationResult validate(@ApiParam(value="schema")@PathVariable("schema") String targetSchema,
                             @ApiParam @RequestBody String record,
    ...
    @RequestMapping(method = RequestMethod.POST,value = "/batch/{schema}")
    @ResponseBody
    ...
    @RequestMapping(method = RequestMethod.POST,value = "/batch/records/{schema}")
    @ResponseBody
