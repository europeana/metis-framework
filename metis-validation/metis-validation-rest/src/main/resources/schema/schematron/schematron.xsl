...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
    ...
    <xsl:template match="ore:Proxy" priority="1000" mode="M17">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="dc:title or dc:description">
                    <xsl:attribute name="location">
                        <xsl:apply-templates select="." mode="schematron-select-full-path"/>
                    </xsl:attribute>
                    <xsl:attribute name="nodeId">
        ...
        <!--ASSERT -->
        <xsl:choose>
            <xsl:when test="(dc:title and normalize-space(dc:title)!='') or (dc:description and (exists(dc:description/@rdf:resource) or normalize-space(dc:decription)!=''))"/>
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
