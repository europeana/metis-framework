...
/**
 * Service that handles all related operations to authentication, including communication between a psql database.
 *
...
public class AuthenticationService {
   ...
   *
   * @param psqlMetisUserDao the psql object to access a postgres database
   */
  @Autowired
